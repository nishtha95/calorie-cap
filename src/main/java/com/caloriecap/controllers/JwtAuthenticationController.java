...
import com.caloriecap.security.config.JwtTokenUtil;
import com.caloriecap.services.JwtUserDetailsService;
...
public class JwtAuthenticationController {
	...
	private void authenticate(String username, String password) throws Exception {
		try {
			...
			throw new CalorieCapException("USER WITH THIS USERNAME IS DISABLED", e);
		} catch (BadCredentialsException e) {
			log.error("Invalid credentials entered by user");
			throw new CalorieCapException("INVALID CREDENTIALS", e);
		}
	}
